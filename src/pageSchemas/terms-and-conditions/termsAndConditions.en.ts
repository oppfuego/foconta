...
Customer means a person or entity purchasing Tokens, redeeming Tokens, or ordering any Service or Deliverable through Foconta.
...
Expert means an independent specialist, freelancer or contractor who has registered with Foconta and may be assigned to prepare, review or assist with Deliverables.
...
3.4. You must notify us immediately at info@foconta.co.uk if you suspect unauthorised access, misuse of your Account, payment fraud, data loss or any other security incident.
...
3.5. We may refuse registration, suspend access, request additional information, or close an Account where we reasonably believe that information is inaccurate, incomplete, misleading, unlawful, fraudulent, abusive or inconsistent with these Terms.`,
        },
        {
            ...
            description:
                `4.1. Foconta provides digital business planning services. Depending on the package selected, the Service may include AI-assisted generation, expert writing, expert review, market and competitor analysis, financial planning support, pitch deck preparation, document formatting and downloadable digital files.

4.2. Foconta is not a law firm, accounting firm, investment adviser, tax adviser, regulated financial adviser, healthcare provider or fundraising intermediary. We provide informational, planning and document preparation support only.
...
8.4. Communication between Customers and Experts must take place only through the Foconta platform, Foconta-managed communication channels, or Foconta email workflows. Direct off-platform communication, circumvention of Foconta, or private payment arrangements are not permitted.
...
8.7. Foconta may add, remove, rename or combine Specialisations from time to time.
...
9.2. Where an Expert is marked as verified, this means that Foconta has completed its internal onboarding or review process for that Expert. It does not guarantee a specific outcome, qualification, licence, professional accreditation, funding result or commercial success.
...
9.4. Foconta may restrict, suspend or remove an Expert if we reasonably believe the Expert has breached confidentiality, failed quality standards, attempted to circumvent the platform, misused Customer information, provided misleading information, or breached these Terms or applicable Expert terms.

9.5. Customers should avoid submitting information that is unnecessary, excessively sensitive, unlawful, confidential to a third party without permission, or subject to restrictions that prevent disclosure to Foconta or assigned Experts.`,
        },
        {
            type: "text",
...
Foconta assigns an Expert based on the Order requirements;

the Expert reviews the brief and may request clarification through Foconta channels;

the Expert prepares or reviews the Deliverable, with AI used only as a support tool where appropriate;

Foconta may conduct an internal quality review where needed;

the Deliverable is supplied electronically through the Service or by email.

10.2. For the Expert 24h Plan, Foconta aims to assign an Expert within 1 Business Hour after the Order is placed, subject to availability, fraud checks, technical availability, completeness of the brief and other operational factors.
...
10.4. Weekends and public holidays are not included in the 24-hour delivery calculation unless an Expert voluntarily works during those periods or Foconta expressly agrees otherwise.
...
10.6. For complex, incomplete, unusual or highly customised Orders, Foconta may extend the delivery timeline after notifying the Customer.
...
12.2. Customers may request cancellation by emailing info@foconta.co.uk and providing the Order reference, Account email and reason for cancellation.
...
12.5. Once an Expert has been assigned, the Order has entered the Expert workflow. Refunds may be limited, reduced or refused, except where required by law or where Foconta determines that a refund, partial refund, Token credit, replacement Expert, rework or other remedy is appropriate.

12.6. If a Customer is dissatisfied with an Expert Deliverable, the Customer must first request a revision or rework through Foconta. Refund review will normally be considered only after a reasonable revision or rework opportunity has been provided.
...
12.8. Foconta support will review disputes based on the original brief, package scope, Customer instructions, Expert work records, delivery evidence, revision history, download/access logs and any supporting materials provided by the Customer.

12.9. Following review, Foconta may, at its discretion and where appropriate:
...
13.4. If a Deliverable is defective, corrupted, incomplete, inaccessible or clearly not as described, you should contact us promptly at info@foconta.co.uk with your Order reference and supporting evidence.`,
        },
        {
            type: "text",
            title: `14. Expert Accounts, Conversion and Payouts`,
            description:
                `14.1. This Section applies to Experts using or registering with Foconta.
...
14.6. Payouts may be made in EUR or USD to a bank account or card, subject to availability, verification, payment provider rules, compliance checks and any instructions provided by Foconta.

14.7. Experts must request payout through the method made available by Foconta. After a payout request, Foconta may contact the Expert by email to provide payout instructions, request details, verify information or confirm payment method.
...
14.9. Foconta may withhold, delay, reduce or cancel payout where an Order is disputed, refunded, charged back, reversed, fraudulent, incomplete, in breach of these Terms, or affected by Expert misconduct or quality failure.

14.10. Token conversion for Experts is an internal settlement mechanism between Foconta and Experts. It does not make Tokens electronic money, securities, cryptocurrency, bank deposits or a general cash-equivalent product for Customers.`,
        },
        {
            type: "text",
...
attempting to contact Experts directly to avoid Foconta fees or controls.
...
16.3. If we reasonably believe that your use of the Service creates legal, security, reputational, payment, fraud or operational risk, we may suspend or restrict your Account.`,
        },
        {
            ...
            description:
                `17.1. Foconta Platform IP. The Service, Platform Materials, templates, workflows, prompts, software, interface, designs, documentation, branding, website content and proprietary methods are owned by Foconta or its licensors and are protected by intellectual property laws.

17.2. Your Inputs. You retain any rights you have in the materials, data, files and instructions you submit to the Service.

17.3. Licence to Foconta. You grant Foconta a worldwide, royalty-free, non-exclusive licence to use, host, process, reproduce, adapt and transmit your inputs and files as necessary to provide, secure, support and improve the Service, comply with law and enforce these Terms.

17.4. Use of Deliverables. Subject to full payment or valid Token redemption, Foconta grants you a non-exclusive, worldwide licence to use the Deliverables for your personal, academic, internal business, commercial planning, investor presentation, lender presentation, client presentation or business development purposes.
...
17.7. Feedback. If you provide feedback, suggestions or ideas, we may use them without restriction or compensation, provided we do not disclose your confidential information in doing so.`,
        },
        {
            ...
            description:
                `18.1. Foconta will use reasonable efforts to keep Customer business information confidential and to make it available only to personnel, Experts, contractors, processors and advisers who need it to provide, support, secure or improve the Service.
...
19.3. Full card details are processed by payment providers. Foconta does not intentionally store full payment card numbers.`,
        },
        {
            type: "text",
...
22.2. Subject to Section 22.1, our total aggregate liability arising out of or in connection with the Service in any 12-month period shall not exceed the total amount paid by you to Foconta for the relevant Services during that 12-month period.
...
22.4. We are not liable for losses caused by inaccurate Customer inputs, missing information, late responses, unauthorised third-party data, misuse of Deliverables, unsupported assumptions, changes in market conditions, third-party requirements, platform outages outside our control, payment provider delays or force majeure events.`,
        },
        {
            ...
            title: `23. Indemnity`,
            description:
                `23.1. You agree to indemnify and hold harmless Foconta, its directors, officers, employees, contractors, Experts, suppliers and service providers from and against claims, losses, damages, liabilities, costs and expenses arising from:
...
you attempt to contact Experts directly or bypass Foconta;
...
25.4. Continued use of the Service after the updated Terms take effect constitutes acceptance of the updated Terms.`,
        },
        {
            ...
            title: `26. Notices`,
            description:
                `26.1. Notices to Foconta should be sent to info@foconta.co.uk or by post to our registered office.
...
28.2. No failure or delay by Foconta to enforce any provision will constitute a waiver.
...
28.5. These Terms, together with the policies referenced in them, form the entire agreement between you and Foconta in relation to the Service.`,
        },
        {
            type: "text",
